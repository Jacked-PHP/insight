...
<div class=" flex flex-col gap-4" x-data="library">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        @foreach($assets as $asset)
            <div class="relative flex items-center space-x-3 rounded-lg border border-gray-300 px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400 @if(!empty($asset->embedding_id)) bg-green-400 @else bg-white @endif">
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('library', () => ({
            ...
            init() {
                ...
                // Native.on("App\\Events\\AssetIndexed", (e) => {
